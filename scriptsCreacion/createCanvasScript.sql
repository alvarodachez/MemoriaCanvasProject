...
ALTER TABLE TAREA ADD CONSTRAINT fk_usuario FOREIGN KEY (idUser) REFERENCES USUARIO(idUsuario) ON DELETE CASCADE ;
...
INSERT INTO TAREA (idTarea, duracion, ESTADO, idUser, nombre)
